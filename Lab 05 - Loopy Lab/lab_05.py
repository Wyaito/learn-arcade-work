...
def draw_section_3():
    ...
    for row in range(30):
        for column in range(30):
            ...
            y = row * row_spacing + bottom_margin  # Instead of zero, calculate the proper y location using 'row'
            if (row % 2 == 0):
                arcade.draw_rectangle_filled(x + 600, y, 5, 5, arcade.color.WHITE)
            else:
                arcade.draw_rectangle_filled(x + 600, y, 5, 5, arcade.color.BLACK)
    ...
    for row in range(30):
        for column in range(30):
            if column < row:
                x = column * column_spacing + left_margin  # Instead of zero, calculate the proper x location using 'column'
                y = row * row_spacing + bottom_margin  # Instead of zero, calculate the proper y location using 'row'
                arcade.draw_rectangle_filled(x + 602, y + 300 , 5, 5, arcade.color.WHITE)
